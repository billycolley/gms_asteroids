...
/// @DnDVersion : 1
/// @DnDHash : 18952F26
/// @DnDArgument : "code" "if(room != rm_start_screen && obj_ship) {$(13_10)	if (random(20) > 19 && obj_ship.tripleshot == 0 && !instance_exists(obj_shield_ship)) {$(13_10)		if (random(2) > 1) {$(13_10)			instance_create_depth(x, y, 1, obj_shield_powerup);$(13_10)		} else {$(13_10)			instance_create_depth(x, y, 1, obj_tripleshot_powerup);$(13_10)		}$(13_10)	}$(13_10)}	"

{
	if(room != rm_start_screen && obj_ship) {
