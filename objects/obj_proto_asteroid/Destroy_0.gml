...
/// @DnDVersion : 1
/// @DnDHash : 18952F26
/// @DnDArgument : "code" "if(room != rm_start_screen && instance_exists(obj_ship)) {$(13_10)	if (random(20) > 19 && obj_ship.tripleshot == 0 && !instance_exists(obj_shield_ship)) {$(13_10)		script_execute(choose_random_powerup_script);$(13_10)	}$(13_10)}	"

{
	if(room != rm_start_screen && instance_exists(obj_ship)) {
	if (random(20) > 19 && obj_ship.tripleshot == 0 && !instance_exists(obj_shield_ship)) {
		script_execute(choose_random_powerup_script);
	}
}	
}
